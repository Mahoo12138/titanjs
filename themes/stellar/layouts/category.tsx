/**
 * Category Layout — Posts filtered by a specific category
 */
...
export default function CategoryLayout(ctx: any) {
  const { site, posts = [], category, route, theme } = ctx
      ...
      <div class="l_main" id="main">
        ...
        <div class="main-content">
          <div class="list-header">
            <h1 class="list-title">📁 {category?.name || ''}</h1>
